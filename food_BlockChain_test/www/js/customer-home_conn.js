...
function setInfo(){
    for(let i=0;i<datas.length;i++) {
        let tmp = "<button id='store"+i+"' data-index='"+datas[0][1]+"' class='store' onclick='javascript:window.location.href = \"customer-storeInfo.html?" + datas[i][0] + "\"'><div id='photo' class='photo'>";
