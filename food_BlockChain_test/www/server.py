...
class TestNetWorkContract:
   ...
   def __init__(self):
      ...
      # 設定合約位址
      self.contract_addr = self.w3.toChecksumAddress('0x8fe376026D07B2468DaaFDC6672a3CEeE2cb67b2')
      self.contract = self.w3.eth.contract(address=self.contract_addr, abi=self.temp_abi)
      # 設定帳號位址
      self.account = self.w3.toChecksumAddress('0x644C5b8cf05FFcc3B602BF0A536602D8547b8787')
